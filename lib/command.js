...
var runComponent = function(quiverComponents, commandArgs, process, callback) {
...
var runModuleAsCommand = function(quiverModule) {
  ...
  moduleLib.loadComponentsFromQuiverModule(quiverModule, function(err, quiverComponents) {
    ...
    runComponent(quiverComponents, optimist.argv, process, function(err) {
      if(err) throw err
...
var runCommand = function(commandArgs, process, callback) {
  ...
  moduleLib.loadQuiverComponentsFromPath(modulePath, function(err, quiverComponents) {
    ...
    runComponent(quiverComponents, commandArgs, process, callback)
  })
}
